...
export default function Terminal() {
  ...
  useEffect(() => {
    // Scroll ONLY the terminal's inner output div — not the whole page.
    // scrollIntoView() was scrolling the entire viewport on every command.
  ...
  return (
    ...
    >
      ...
      {/* Output */}
      <div ref={outputRef} className="flex-1 overflow-y-auto px-6 py-5 font-mono">
        ...
        {showPortrait && (
          <div className="flex flex-col sm:flex-row gap-6 items-start">
            ...
            <div className="flex-shrink-0 hidden sm:block">
              <AsciiAvatar cols={65} rows={44} color="var(--accent, #00ff41)" />
            </div>
